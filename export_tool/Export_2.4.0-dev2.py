...
class ADVANCED_GLB_PT_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        version_box.label(text="🚀 Version 2.4 dev2 (Experimental)", icon='EXPERIMENTAL')
...
class AdvancedGLBPreferences(bpy.types.AddonPreferences):
    ...
    enable_experimental_features: BoolProperty(
        ...
        default=False,
        description="Enable experimental features from dev2 (may be unstable)"
    )
    ...
    def draw(self, context):
        ...
        experimental_box = layout.box()
        experimental_box.label(text="Experimental Features", icon='EXPERIMENTAL')
        experimental_box.prop(self, "enable_experimental_features")
